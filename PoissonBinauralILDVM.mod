TITLE PoissonBinauralILDVM.mod  Binaural Inhomogenous Poisson: 
 : binaural von Mises probability distributions w/ Interaural Level Difference
...
COMMENT
 ...
 :------------------STIMULUS SPECIFIC Description --------------------------
  ...
  of Circular Data), differing only in phase and level between ipsi and contra
 :--------------------------------------------------------------------------
ENDCOMMENT
...
NEURON {
 ...
 :------------------STIMULUS SPECIFIC POINT_PROCESS name -------------------
   POINT_PROCESS PoissonBinauralILDVM
 :--------------------------------------------------------------------------
 ...
 :------------------STIMULUS SPECIFIC RANGE variables ----------------------
  ...
  : ASSIGNEDs
   angfreq, stimProb, kappa, norm, stim, ampILD,
 :--------------------------------------------------------------------------
...
PARAMETER {
 ...
 :------------------STIMULUS SPECIFIC PARAMETERs ---------------------------
  ...
  genericParam1 = 0 : amplification factor of contra over ipsi, in dB
...
ASSIGNED {
 :------------------STIMULUS SPECIFIC ASSIGNEDs ----------------------------
  ...
  kappa (1)
  norm (1)
  ampILD (1) : amplification factor of contra over ipsi
 :--------------------------------------------------------------------------
...
:------------------STIMULUS SPECIFIC Stimulus Functions -------------------
 ...
 FUNCTION calcStimContra() {
  ...
  :amplified von Mises prob. distribution (phase = 2 pi freq t + phiContra)

  calcStimContra = ampILD*norm*exp(kappa*sin(angfreq*t+stimPhaseContra))
